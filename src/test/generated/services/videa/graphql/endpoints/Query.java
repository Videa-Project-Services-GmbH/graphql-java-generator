...
public class Query {
  ...
  public MembershipNode membership(String id) throws IOException {
  ...
  public MembershipNodeConnection allMemberships(Integer first, Integer last, String before,
      String after, String id, String user, String carsharinggroup, String orderBy) throws
      IOException {
    Request request = new Request();
  ...
  public SharingGroupNode sharingGroup(String id) throws IOException {
    Request request = new Request();
  ...
  public SharingGroupNodeConnection allSharingGroups(Integer first, Integer last, String before,
      String after, String id, String name, String orderBy) throws IOException {
    Request request = new Request();
  ...
  public VehicleNode vehicle(String id) throws IOException {
    Request request = new Request();
  ...
  public VehicleNodeConnection allVehicles(PositionInput position, AvailabilityInput availability,
      Integer first, Integer last, String before, String after, String id, String zip, String city,
      String description, String orderBy) throws IOException {
    Request request = new Request();
  ...
  public UserNode user(String id) throws IOException {
    Request request = new Request();
  ...
  public UserNodeConnection allUsers(Integer first, Integer last, String before, String after,
      String id, String username, String email, String firstName, String lastName, String orderBy)
      throws IOException {
    Request request = new Request();
  ...
  public CityNode city(String id) throws IOException {
    Request request = new Request();
  ...
  public CityConnection allCities(String before, String after, Integer first, Integer last) throws
      IOException {
    Request request = new Request();
  ...
  public DataStoreNode dataStore() throws IOException {
    Request request = new Request();
  ...
  public EnvironmentNode environment() throws IOException {
    Request request = new Request();
  ...
  public ReservationNode reservation(String id) throws IOException {
    Request request = new Request();
  ...
  public ReservationNodeConnection allReservations(List<ReservationStateEnum> state, Integer first,
      Integer last, String before, String after, String id, String startLt, String startLte,
      String startGt, String startGte, String startRange, String endLt, String endLte, String endGt,
      String endGte, Boolean isFishing, Boolean isAccessibleOnly, Boolean isCurrentUserOnly,
